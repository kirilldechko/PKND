...
control_person_button = "Контролируемые лица"
subject_type = ["Юридическое лицо", "Индивидуальный предприниматель", "Физическое лицо", "Иностранное юридическое лицо"]
choose_subject_button = "Выбрать из реестра"
