...
# from tests.test_knm_and_pm_501_st import kno_and_knm_data
#
#
# # from tests.test_knm_and_pm_501_st import subject_data
#
#
...
#         self.page.wait_for_load_state()  # Ждем завершения сетевых запросов
#         self.page.wait_for_load_state()  # Ждем загрузки DOM
...
#         add_button.click()
#
#     @allure.step("Выбрать чекбокс по названию")
#     def choose_checkbox_by_name(self, checkbox_name):
#         checkbox = self.find_elem(knm_and_pn_page_loc.find_type_of_control_subject(checkbox_name))
#         checkbox.click()
#         subject_icon = self.find_elem(knm_and_pn_page_loc.find_new_subject_type_name(checkbox_name))
#         expect(subject_icon).to_be_visible()
#
#     @allure.step("Нажать кнопку Выбрать из реестра")
#     def press_button_by_name(self, button_name):
#         find_button = self.find_elem(knm_and_pn_page_loc.find_button_choose_subject_from_registry(button_name))
#         find_button.click()
#         expect(find_button).not_to_be_visible()
#
#     @allure.step("Заполнений данных на вкладке Контролируемое лицо")
#     def fill_data_to_controlled_person_subject(self, subject_data):
#         self.go_to_the_left_tab_by_name(subject_data["control_person_button"])
#         self.click_create_button(subject_data["add_button_name"])
#         self.choose_checkbox_by_name(subject_data["subject_type"])
#         self.press_button_by_name (subject_data["subject_registry_button"])
#
#         """ Надо создать класс Глобальные субъекты и из него выбрать субъект"""
#
#
#
#
