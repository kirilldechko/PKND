...
from pages.servises_page.servises_page_data import servises_page_data as srv_p_data
...
# Тестовые данные для создания обращения
create_case_data = {
"code_fild_name": srv_p_data.code_fild_name,
"service_name": srv_p_data.service_name,
"service_number": srv_p_data.service_number[0],
"create_button_name": srv_p_data.create_button_name
}

@allure.feature('Test Appeals Page')
@allure.story('Test Appeals Page')
@allure.title('Create Appeals')
def test_select_appeals(authorisation_page, organisation_page, application_page, appeals_page, service_page):
    ...
    service_page.choose_service_and_create_case(create_case_data)
